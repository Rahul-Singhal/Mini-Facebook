<?php
	...
	$followers = "select * from Follow where followed_user_id = \"".$_SESSION['userId']."\";"; 
...
<html>
  <head>
	...
	#followerX{
		background-color:rgba(230,255,204,0.3);
	}
	#results{
			...
			<div class="row-fluid " id="panelGuest">
				<div class="span3" style="border-right:4px solid #007AA3;">
					...
					<ul class="nav nav-list" id="left-menu">
						...
						<li class="active"><a href="#">Follower List</a></li>
				...
				<div class="span7 offset1">
					...
					<?php 
						$count =0;
					 if($query_out1 = mysql_query($followers)){
							echo "<div class=\"row-fluid\">";
							while($_SESSION['friends'] = mysql_fetch_assoc($query_out1)){
								$followername = "select first_name,last_name from Profile where user_id = \"".$_SESSION['friends']['followedby_user_id']."\";";
								$query_out = mysql_query($followername);
								$_SESSION['friendname'] = mysql_fetch_assoc($query_out);
								$count++;
					
			      echo "<div class=\"span6\" id=\"followerX\">
						<dl class=\"dl-horizontal\">
						<dt> <h4> <a href=\"profile.php?user_id=".$_SESSION['friends']['followedby_user_id']."\">
															".$_SESSION['friendname']['first_name']." </a> </h4> </dt>
						<dd> <a href=\"profile.php?user_id=".$_SESSION['friends']['followedby_user_id']."\">
							<button class=\"btn btn-success\"> Go to profile </button> </a> </dd>
					</div>";
